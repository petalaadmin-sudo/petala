# Item 7A - Estrutura Mestre dos Termos e Aceites Destacados

Documento interno - Petala/Bloom

Status: versao interna v1, aprovada como referencia para produto, juridico, compliance, engenharia, suporte, moderacao e operacao. Este documento nao esta publicado no site e deve ser revisado juridicamente antes de virar Termos publicos, Politica publica, fluxo de aceite final ou comunicacao regulatoria.

## 1. Objetivo

Este documento define a estrutura mestre para Termos, politicas e aceites destacados do Petala/Bloom.

O objetivo e garantir que usuarios, criadoras, agentes e agencias entendam com clareza os principais direitos, deveres, riscos, limites, regras financeiras, regras de conteudo, regras de privacidade, medidas de moderacao e consequencias de violacoes.

Tambem orienta como registrar tecnicamente cada aceite para preservar prova, versao, data, contexto, integridade do texto aceito e capacidade de reaceite quando houver mudanca relevante.
...
Todo documento de Termos ou politica relevante deve conter, no minimo:

- Nome do documento.
- Versao.
- Data de vigencia.
- Escopo de aplicacao.
- Publico aplicavel: usuario, criadora, agente, agencia, admin ou parceiro.
- Resumo objetivo.
- Definicoes essenciais.
- Regras principais.
- Condutas proibidas.
- Consequencias de violacao.
- Regras financeiras, quando aplicavel.
- Regras de privacidade e dados, quando aplicavel.
- Regras de moderacao e revisao.
- Processo de alteracao.
- Processo de denuncia, disputa ou suporte.
- Referencia a documentos relacionados.
- Aviso de que direitos obrigatorios preservados por lei nao sao renunciados.

## 4. Aceite geral

O aceite geral deve cobrir o uso da plataforma, conta, regras basicas de conduta, privacidade, seguranca, uso de creditos internos, moderacao, suporte, atualizacoes e documentos vinculados.
...
- tipo de conta: usuario, criadora, agente, agencia ou admin.
- documento aceito.
- versao do documento.
- hash do texto aceito.
- timestamp do aceite.
- IP, quando legalmente permitido.
- user agent ou contexto tecnico equivalente, quando util.
- origem do aceite: cadastro, login, checkout, chamada, upload, painel, convite, reaceite ou outro fluxo.
- idioma ou localidade, quando aplicavel.
- checkbox/acao destacada aceita.
- identificador do fluxo ou tela.
- referencia ao texto exibido no momento.
...
O hash deve representar o conteudo apresentado ao usuario naquele aceite. Se o texto mudar, o hash deve mudar.

O objetivo e permitir prova tecnica de que determinada pessoa aceitou exatamente aquela versao, e nao apenas um nome generico de documento.
...
- Regras financeiras.
- Regras de petalas, repasses, bloqueios, chargebacks ou reembolsos.
- Regras de conteudo 18+.
- Regras de chamadas, mensagens ou fotos pagas.
- Regras de criadoras, agentes ou agencias.
- Politica de privacidade com impacto relevante.
- Resolucao de disputas.
- Arbitragem, foro ou limitacao de responsabilidade.
- Qualquer regra que altere risco, direito, dever, cobranca, repasse, consentimento ou moderacao de forma relevante.
...
Sempre que possivel, deve haver tentativa de solucao amigavel antes de medida formal, sem impedir direitos obrigatorios do consumidor, da criadora, da agencia ou da plataforma.
...
A arbitragem nao deve ser apresentada como obrigatoria para tudo, sem excecao. A clausula deve respeitar direitos obrigatorios, normas de consumidor, limites legais, consentimento valido e hipoteses em que arbitragem nao seja permitida ou nao seja exigivel.
...
Nao deve haver promessa de irresponsabilidade absoluta. A plataforma nao deve afirmar que nunca tera responsabilidade, nem que o usuario renuncia a todos os direitos.
...
Deve ficar claro que a plataforma pode bloquear temporariamente valores internos, creditos, repasses, beneficios, elegibilidade financeira ou funcionalidades quando houver suspeita de fraude, chargeback, abuso, violacao de regra, disputa, investigacao, risco legal ou necessidade de conciliacao.
...
Banimento imediato pode ser previsto para casos graves, como menoridade, conteudo nao consensual, exploracao, coacao, fraude, trafico, aliciamento, contato externo para burlar pagamento, ameaca, chantagem, violacao de direitos ou risco legal relevante.
...
- Violacao de propriedade intelectual.
- Chargeback abusivo.
- Coercao.
- Exploracao.
- Burla de pagamento.
...
- Conteudo nao consensual.
- Envolvimento de menores.
- Contato externo proibido.
- Violacoes graves dos Termos ou politicas aplicaveis.
...
- "Voce nunca podera processar a plataforma."
- "A plataforma nunca tera responsabilidade."
- "O usuario renuncia a todos os direitos."
- "A plataforma pode bloquear qualquer valor sem motivo."
- "A arbitragem e obrigatoria para tudo, sem excecao."
...
- "quando legalmente aplicavel";
- "sem prejuizo de direitos obrigatorios";
- "mediante registro interno de motivo";
- "sujeito a revisao de compliance".
...
Alteracoes materiais devem exigir novo aceite destacado quando afetarem direitos, deveres, riscos, cobrancas, repasses, consentimento, privacidade, moderacao, bloqueio, disputa ou elegibilidade financeira.
...
Ele deve orientar a construcao futura dos Termos de Uso, Politica de Privacidade, Politica de Conteudo 18+, Politica Financeira, Politica de Reembolso, Politica de Denuncias, Politica de Criadoras, Politica de Agencias e fluxos de aceite destacados.

Antes de publicacao, todas as clausulas devem passar por revisao juridica, revisao de compliance, revisao de produto e validacao tecnica de registro/versionamento.
